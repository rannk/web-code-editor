    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $.each(data, function(idx, item){
                ...
                if(item.hasfile == "1") {
                    content += "<span class='fa fa-caret-right tag' />";
                }else {
                    left = "left20";
                }
            ...
            if(check_double > 1) {
                ...
                if(obj.attr("type") == "folder") {
                    ...
                    if(child_obj.is(":hidden")){
                        obj.children("div").children(".tag").removeClass("fa-caret-right");
                        obj.children("div").children(".tag").addClass("fa-caret-down");
                        child_obj.show();
                        ...
                        obj.children("div").children(".tag").removeClass("fa-caret-down");
                        obj.children("div").children(".tag").addClass("fa-caret-right");
                        child_obj.hide();
                    }
                }
